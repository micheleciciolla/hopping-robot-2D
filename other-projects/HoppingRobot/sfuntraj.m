...
%   $Revision: 1.6.4.5 $ $Date: 2008/05/31 23:31:14 $ $Author: batserve $
%
% Modified by Guy Rouleau - 2008
...
% Initialization
  case 0
    ...
    wh=vrworld(get_param([model_name '/Data Display and Analysis/VR Sink'], 'WorldFileName'));
